<template>
  ...
  >
    ...
    <div class="mx-3 text-sm font-normal line-clamp-2">
      {{ message }}
    </div>
    <button
      @click="$emit('close')"
      type="button"
      class="ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex h-8 w-8 transition-all cursor-pointer"
    >
